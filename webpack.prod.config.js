...
const config = require(`./config/${argv.flavor}`);
...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.HotModuleReplacementPlugin(), // TODO - Remove Hot loader. Temporarily enabled in production to avoid hmr error.
